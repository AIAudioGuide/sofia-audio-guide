...
const LANDMARKS = [
  { 
    ...
    exactPath: true,
    waypointsToNext: [{ lat: 42.696624285510815, lng: 23.321864950027777 }],
  ...
  { 
    ...
    exactPath: true,
    waypointsToNext: [
      { lat: 42.69750197081598, lng: 23.322080856915274 },  // beginning of stairs (exact)
      { lat: 42.69758476426109, lng: 23.32210566734683 },   // end of stairs (exact)
    ],
  ...
  { 
    ...
    waypointsToNext: [
      ...
      { lat: 42.69773114295113, lng: 23.323858921511412 },  // path after stairs (exact)
    ],
  ...
  { 
    ...
    lat: 42.6960975895997, lng: 23.33169497622479,
    viewingPoint: { lat: 42.6960975895997, lng: 23.33169497622479 },
