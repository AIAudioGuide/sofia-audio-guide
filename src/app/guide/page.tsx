...
const LANDMARKS = [
  { id: 1, name: { en: 'Alexander Nevsky Cathedral' }, lat: 42.6961, lng: 23.3324, desc: { en: 'The iconic gold-domed Orthodox cathedral, built in 1882 in memory of Russian Tsar Alexander II.' }, image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c0/Catedral_de_Alejandro_Nevski_--_2019_--_Sof%C3%ADa%2C_Bulgaria.jpg/640px-Catedral_de_Alejandro_Nevski_--_2019_--_Sof%C3%ADa%2C_Bulgaria.jpg' },
  { id: 2, name: { en: 'St. George Rotunda' }, lat: 42.6970, lng: 23.3231, desc: { en: 'One of the oldest buildings in Sofia, a 4th-century Roman church.' }, image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/46/Rotunda_Saint_George_Sofia.jpg/640px-Rotunda_Saint_George_Sofia.jpg' },
  { id: 3, name: { en: 'National Palace of Culture' }, lat: 42.6850, lng: 23.3190, desc: { en: "Sofia's largest conference and cultural center, built in 1981." }, image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/ec/National_Palace_of_Culture_%2823997858848%29.jpg/640px-National_Palace_of_Culture_%2823997858848%29.jpg' },
  { id: 4, name: { en: 'St. Sofia Church' }, lat: 42.6967, lng: 23.3316, desc: { en: 'A medieval church from the 6th century, giving the city its name.' }, image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/40/St_Sofia_Church_Sofia.jpg/640px-St_Sofia_Church_Sofia.jpg' },
  { id: 5, name: { en: 'Banya Bashi Mosque' }, lat: 42.7011, lng: 23.3358, desc: { en: 'Ottoman-era mosque now housing the National Archaeological Museum.' }, image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/40/Banya_Bashi_Mosque_Sofia.jpg/640px-Banya_Bashi_Mosque_Sofia.jpg' },
  { id: 6, name: { en: 'City Garden' }, lat: 42.6951, lng: 23.3253, desc: { en: 'The oldest public park in Sofia, opened in 1878.' }, image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4d/Sofia-garden-kiosk-georgivar.jpg/640px-Sofia-garden-kiosk-georgivar.jpg' },
  { id: 7, name: { en: 'Vitosha Boulevard' }, lat: 42.6947, lng: 23.3208, desc: { en: 'The main shopping street, lined with historic cafes and boutiques.' }, image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/61/Vitosha_boulevard%2C_Sofia.jpg/640px-Vitosha_boulevard%2C_Sofia.jpg' },
  { id: 8, name: { en: 'Tsar Osvoboditel Monument' }, lat: 42.6938, lng: 23.3320, desc: { en: 'Monument to the Russian Tsar who liberated Bulgaria from Ottoman rule.' }, image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6e/Tsar_Osvoboditel_Monument_Sofia.jpg/640px-Tsar_Osvoboditel_Monument_Sofia.jpg' },
];
